              ...
              <table class="table table-hover tabel_el">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td></td>
                    <td><a href="#" class="badge badge-success acceptRKSP" data-id="<?= $p['id_tracking'];?>" data-toggle="modal" data-target="#modalTrack" <?php $ref = $this->db->get_where('tracking', ['ref' => $p['ref'], 'jenis' => 'accept_rksp'])->num_rows(); if ($ref > 0) echo "hidden";?>>Accept</a></td>
                  </tr>
                <?php endforeach;?>
                </tbody>
              </table>
